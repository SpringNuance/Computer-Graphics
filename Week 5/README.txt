...
Hours spent on requirements (approx.): 35
...
No, I didnt do any extra credits. The requirements are already too difficult on their own
I have generated images from R1 to R9 in the folder called Images reports. You can check them out

# Are there any known problems/bugs remaining in your code?
In antialiasing, the regular sampler doesnt resemble the example.exe. Also the jiggler cannot be refreshed by clicking raytracing multiple times. I dont know why the anti aliasing is not behaving like
the example.exe
...
This assignment is really large and diffcult project. It would be better if it is more evenly distributed with week 6
